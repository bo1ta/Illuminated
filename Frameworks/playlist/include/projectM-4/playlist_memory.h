 ...
 *
 * Please only use this function with char pointers returned by the playlist
 * library, and don't use other projectM memory management functions with
 * pointers returned by the playlist library.
 *
 ...
 *
 * Please only use this function with pointers returned by the playlist library,
 * and don't use other projectM memory management functions with pointers
 * returned by the playlist library.
 *
