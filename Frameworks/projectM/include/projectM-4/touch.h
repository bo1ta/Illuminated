 ...
 *
 * This will add or move waveforms in addition to the preset waveforms. If there
 * is an existing waveform at the given coordinates, it will be centered on the
 * new coordinates. If there is no waveform, a new one will be added.
 *
 ...
 * @param pressure The amount of pressure applied in a range from 0.0 to 1.0.
 */
PROJECTM_EXPORT void projectm_touch_drag(projectm_handle instance, float x,
                                         float y, int pressure);
 ...
 */
PROJECTM_EXPORT void projectm_touch_destroy(projectm_handle instance, float x,
                                            float y);
