 ...
 *
 * Each PCM data UpdateMeshSize should not exceed this number of samples. If
 * more samples are added, only this number of samples is stored and the
 * remainder discarded.
 *
 ...
 *
 * This function is used to add new audio data to projectM's internal audio
 * buffer. It is internally converted to 2-channel float data, duplicating the
 * channel.
 *
 ...
 */
PROJECTM_EXPORT void projectm_pcm_add_float(projectm_handle instance,
                                            const float *samples,
                                            unsigned int count,
 ...
 * Can be PROJECTM_MONO or PROJECTM_STEREO.
 */
PROJECTM_EXPORT void projectm_pcm_add_int16(projectm_handle instance,
 ...
 * Can be PROJECTM_MONO or PROJECTM_STEREO.
 */
PROJECTM_EXPORT void projectm_pcm_add_uint8(projectm_handle instance,
