...
@property(nonatomic, strong, readwrite) PlaylistsSidebarViewController *libraryViewController;
@property(nonatomic, strong, readwrite) FilesSidebarViewController *fileBrowserViewController;
...
- (void)setupControllers {
  self.libraryViewController = [[PlaylistsSidebarViewController alloc] init];
  self.fileBrowserViewController = [[FilesSidebarViewController alloc] init];
}
